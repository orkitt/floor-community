...
Refer to [GitHub Discussions](https://github.com/orkitt/floor-community/discussions) for questions, ideas, and discussions.
...
For further examples take a look at the [example](https://github.com/orkitt/floor-community/tree/develop/example) and [test](https://github.com/orkitt/floor-community/tree/develop/floor/test/integration) directories.

## Naming

The library's name derives from the following.
_Floor_ as the _bottom layer_ of a [Room](https://developer.android.com/topic/libraries/architecture/room) which points to the analogy of the database layer being the bottom and foundation layer of most applications.
Where _fl_ also gives a pointer that the library is used in the Flutter context.

## Bugs, Ideas, and Feedback

For bugs please use [GitHub Issues](https://github.com/orkitt/floor-community/issues).
For questions, ideas, and discussions use [GitHub Discussions](https://github.com/orkitt/floor-community/discussions).

## Announcement
> [!NOTE]
> This repository is a **community-maintained fork** of the original **Floor** project. Our goal is to keep the package alive by providing bug fixes, compatibility updates, performance improvements, and support for newer versions of Dart and Flutter while preserving the original developer experience. We intend to remain as close to the upstream API as possible, ensuring existing applications can migrate with minimal or no code changes. Community contributions, issue reports, and pull requests are always welcome as we work together to keep Floor reliable for modern Flutter development. The original Floor project can be found here: https://github.com/orkitt/floor-community.
>
## License
