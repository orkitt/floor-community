...
import 'package:floor_generator_community/processor/error/processor_error.dart';
...
Future<DartType> getDartTypeWithPerson(String value) async {
  ...
  return (libraryReader.allElements.elementAt(2) as GetterElement)
      .type
      .returnType;
}
...
Future<DartType> getDartTypeFromDeclaration(final String declaration) async {
  ...
  return (libraryReader.allElements.elementAt(1) as GetterElement)
      .type
      .returnType;
}
...
Future<Dao> createDao(final String methodSignature) async {
  ...
  final daoClass = libraryReader.classes.firstWhere((classElement) =>
