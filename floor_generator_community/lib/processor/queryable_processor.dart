...
import 'package:floor_generator_community/misc/extension/type_converters_extension.dart';
import 'package:floor_generator_community/misc/type_utils.dart';
import 'package:floor_generator_community/processor/error/queryable_processor_error.dart';
import 'package:floor_generator_community/processor/field_processor.dart';
import 'package:floor_generator_community/processor/processor.dart';
import 'package:floor_generator_community/value_object/field.dart';
    ...
    if (field != null) {
      ...
      if (typeConverter != null) {
        ...
        throw InvalidGenerationSourceError(
          ...
          todo:
              'Either use a supported type https://github.com/orkitt/floor-communityentities/#supported-types or supply a type converter.',
        );
      }
